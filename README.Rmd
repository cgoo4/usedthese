...
1.  With `used_here()`, make it super easy to add a nicely-rendered summary table of R package & function usage, consistent with knitr's syntax highlighting, to the foot of a Quarto or R Markdown document. [Development version available.]
