...
There's a nice additional benefit too. Quarto websites have a search bar. And whilst the results *exclude* code, they *include* the contents of the usage table. So, for example, if you search [quantumjitter.com](https://www.quantumjitter.com/project/) for "separate_wider_regex" you can find any project using that function.
